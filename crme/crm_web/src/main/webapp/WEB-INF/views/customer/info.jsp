            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        ...
                        <button rel="${customer.id}" id="publicBtn" class="btn bg-maroon btn-sm"><i class="fa fa-recycle"></i> 放入公海</button>
                ...
                <div class="box-footer">
                    <spans style="color: #00c0ef"><i class="fa fa-exchange"></i> ${customer.reminder}</spans>
    ...
    $(function () {
        ...
        $("#publicBtn").click(function () {
            ...
            layer.confirm("确定要放入公海吗？",function () {
                window.location.href="/customer/my/"+ custId + "/share/public";
            });
        });
    })
</script>
